...
(
	...
	'row_site_banner_img' => "网站Banner",
	'text_site_banner_img_note' => "网站Banner图片文件。建议图片尺寸为1228x262。如不填写，将使用文字。默认''。",
	'row_site_banner_link' => "网站Banner跳转链接",
	'text_site_banner_link_note' => "网站Banner点击跳转的链接。不需要跳转时可留空。",
	'row_site_background_image' => "网站背景图",
	'row_site_background_image_note' => "网站背景图，默认为空。",
