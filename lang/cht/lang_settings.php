...
(
	...
	'row_site_banner_img' => "網站Banner",
	'text_site_banner_img_note' => "網站Banner圖片檔案。建議圖片大小為1228x262。如不填寫，將使用文字。預設''。",
	'row_site_banner_link' => "網站Banner跳轉鏈接",
	'text_site_banner_link_note' => "網站Banner點擊跳轉的鏈接。不需要跳轉時可留空。",
	'row_site_background_image' => "網站背景圖",
	'row_site_background_image_note' => "網站背景圖，默認為空",
